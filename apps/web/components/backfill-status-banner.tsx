...
export function BackfillStatusBanner({
  ...
  return (
    <div className="border-y border-emerald-300/14 bg-[linear-gradient(180deg,rgba(21,178,104,0.9),rgba(16,153,90,0.82))] px-4 py-2 shadow-[0_-10px_28px_rgba(0,0,0,0.18)] backdrop-blur-xl">
