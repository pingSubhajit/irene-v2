            ...
            >
              ...
              <span className="relative flex size-11 items-center justify-center">
                ...
                {tab.href === "/review" && reviewAttentionCount > 0 ? (
                  <span className="absolute right-0.5 top-0.5 min-w-[1rem] rounded-full bg-[var(--neo-coral)] px-1 py-[1px] text-center text-[0.5rem] font-semibold leading-none tracking-normal text-black shadow-[0_0_18px_rgba(255,122,92,0.36)]">
